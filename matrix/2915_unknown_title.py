"""
LeetCode Problem #2915: Check if Matrix is X-Matrix
...
All the elements in the diagonals are non-zero, and all other elements are 0. Hence, the grid is an X-Matrix.
...
Input: grid = [[5,7,0],
               ...
               [0,5,0]]
Output: False
Explanation: The grid is not an X-Matrix because grid[0][1] is 7, which is not on a diagonal and is not 0.
