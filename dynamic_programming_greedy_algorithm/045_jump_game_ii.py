...
def jump(nums):
    ...
    :param nums: List[int] - The input array representing maximum jump lengths.
    :return: int - The minimum number of jumps required to reach the last index.
    """
    n = len(nums)
    if n == 1:
        return 0
...
# Topic: Dynamic Programming / Greedy Algorithm