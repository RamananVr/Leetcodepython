"""
LeetCode Problem #2937: [Problem Title]

Problem Statement:
(Note: As of my knowledge cutoff in October 2023, LeetCode Problem #2937 does not exist. 
For the sake of this exercise, I will create a fictional problem statement.)

You are given an array of integers `nums` and an integer `k`. Your task is to find the 
maximum sum of any subarray of length `k`.

A subarray is a contiguous part of an array. If the array has fewer than `k` elements, 
return 0.
...
if __name__ == "__main__":
    ...
    nums2 = [5, 1, 3, 2, 6, 7]
    k2 = 3
    print(max_sum_subarray(nums2, k2))  # Output: 15
