...
1. For every pickup(i), there is a corresponding delivery(i).
2. Delivery(i) must occur after pickup(i).
3. No two pickups or deliveries can occur at the same time.
...
"""
Time Complexity:
The solution iterates from 1 to n, performing constant-time operations in each iteration.
