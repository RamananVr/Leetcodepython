...
Output: 6
Explanation: The elevation map (shown in the problem description) traps 6 units of rain water.
...
if __name__ == "__main__":
    ...
    # Test Case 3
    height3 = [1,0,2,0,1,0,3]
    print(f"Test Case 3: {trap(height3)}")  # Expected Output: 5
...
"""
Time Complexity:
- O(n): We traverse the height array once using two pointers (left and right).
